...
import com.alvexcore.repo.MasterDataExtension;
...
{
	protected ServiceRegistry serviceRegistry;
	protected MasterDataExtension extension;
	protected NodeRef containerRef;
	protected String propertyName;
	protected String masterDataSourceName;

	public attachMasterDataWork(ServiceRegistry serviceRegistry, MasterDataExtension extension,
	...
	public Void doWork() throws Exception {
		...
		NodeRef configFolder = extension.getNodeFromCache(
					MasterDataExtension.ID_MASTER_DATA_SERVICE_CONFIG_PATH);
...
class createMasterDataSourceWork implements RunAsWork<NodeRef>
{
	...
	public createMasterDataSourceWork(ServiceRegistry serviceRegistry,
			MasterDataExtension extension, Map<String,String> props)
	{
		this.serviceRegistry = serviceRegistry;
		this.extension = extension;
		this.props = props;
	...
	public NodeRef doWork() throws Exception {
		NodeService nodeService = serviceRegistry.getNodeService();
		NodeRef configFolder = extension.getNodeFromCache(
					MasterDataExtension.ID_MASTER_DATA_CONFIG_PATH);
		...
		NodeRef dataFolder = extension.getNodeFromCache(
					MasterDataExtension.ID_MASTER_DATA_DATA_PATH);
...
public class AlvexMasterDataServiceImplCE implements InitializingBean, AlvexMasterDataService
{
	...
	// @Required
	public void setMasterDataExtension(MasterDataExtension extension) {
		this.extension = extension;
	}
